    ...
    return(
        <div className='bio'>
            ...
            <div className='bio-content'>
                ...
                <p>I have experience building web applications consisting of responsive and dynamic design. I enjoy turning ideas into functioning applications. Love taking on challenging tasks and learning new technologies.</p>
            </div>
        </div>
    );
}
